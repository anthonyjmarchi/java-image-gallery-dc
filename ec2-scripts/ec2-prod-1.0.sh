...
cd /home/ec2-user
git clone https://github.com/anthonyjmarchi/java-image-gallery-dc.git
chown -R ec2-user:ec2-user java-image-gallery-dc
...
su ec2-user -l -c 'cd ~/java-image-gallery-dc && ./start' >/var/log/image_gallery.log 2>&1 &
